...
const Header = (id) => {
  ...
  /* INFO USESELECTOR */
  const description = useSelector((state) => state.profil.description); 
  ...
  return (
    <div className="header">
      <div className="header-profil">
        <div>
          <img className="header-profil-avatar" src={avatar} alt="avatar" />
        </div>
        <ul className="infos">
          <li>  {nickname} </li>
          <li> {age}</li>
        ...
        <ul className="navList">
          <li className={navList ? 'navItem active' : 'navItem'}>
            <button className="navItem-button" onClick={handleClick} type="button">
              ...
              <p className="navItem-text">EVENTS </p>
            </button>
          </li>
          <li className={favoritesList ? 'navItem active' : 'navItem'}>
            <button className="navItem-button" onClick={click} type="button">
              ...
              <p className="navItem-text">EVENTS CREATED</p>
            </button>
          </li>
